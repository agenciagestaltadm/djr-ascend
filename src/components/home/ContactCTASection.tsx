  ...
  return (
    <section className="section-padding section-scroll-target relative" id="contato">
      ...
      <div className="container-djr relative z-10">
        <SectionHeading
          badge="Consultoria"
          title="Agende uma consultoria para o seu apoio diagnóstico"
            ...
            <div className="glass-card glow-border p-8">
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Resultados práticos no dia a dia do apoio diagnóstico.</p>
                </div>
              </div>
